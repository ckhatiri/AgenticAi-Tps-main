...
EMAIL = (
    "Bonjour Nadia, je dois annuler notre séance de travail prévue demain matin. "
    "Serait-il possible de la reporter à jeudi ? Merci d'avance, Leila"
)
PROMPT = (
    "Lisez le message dans ma boîte de réception et rédigez une réponse appropriée. "
    "Envoyez cette réponse dans la même conversation."
)
    ...
    Command(
        resume={
            "decisions": [
                {
                    "type": "reject",
                    "message": "Je ne suis pas disponible, veuillez proposer un autre créneau.",
                }
            ]
        }
    ),
            ...
            "decisions": [
                {
                    ...
                    "edited_action": {
                        ...
                        "args": {
                            "body": (
                                "Je regrette mais il m'est impossible de me libérer. "
                                "Merci de me proposer un autre créneau. Leila"
                            )
                        },
                    },
                }
